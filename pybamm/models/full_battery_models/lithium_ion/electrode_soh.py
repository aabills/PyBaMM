...
class ElectrodeSOHSolver:
    ...
    def _check_esoh_feasible(self, inputs):
        ...
        if self.options["open-circuit potential"] == "MSMR":
            ...
            inputs.update({"x": x100_max, "y": y100_min}, check_already_exists=False)
