...
def get_initial_stoichiometry_half_cell(
    ...
    x_0, x_100 = get_min_max_stoichiometries(parameter_values, user_inputs=user_inputs)
...
def get_min_max_stoichiometries(
    parameter_values, options={"working electrode": "positive"}, user_inputs = {}
):
    """
    ...
    esoh_sol = esoh_sim.solve([0], inputs=user_inputs)
